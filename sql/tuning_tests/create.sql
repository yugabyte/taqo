...
INSERT INTO t_buckets_4 (SELECT s, s FROM generate_series(1, 10000000) s);
...
INSERT INTO t_buckets_8 (SELECT s, s FROM generate_series(1, 10000000) s);
...
INSERT INTO t_buckets_16 (SELECT s, s FROM generate_series(1, 10000000) s);
...
INSERT INTO t_buckets_32 (SELECT s, s FROM generate_series(1, 10000000) s);