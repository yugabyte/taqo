SELECT c1, c2 FROM table_simple WHERE bucketid IN (0,1,2) ORDER BY c1, c2 limit 10;
...
SELECT c2, c4 FROM table_simple WHERE c2 = 10 ORDER BY c2, c4 limit 2;
...
SELECT c1, v FROM table_simple WHERE c1 > length(v) ORDER BY c1, v limit 10;
SELECT c1, v FROM table_simple WHERE length(v) BETWEEN 10 AND 20 ORDER BY c1, v limit 10;
...
SELECT c1, c2, c3, c4 FROM table_simple ORDER BY c1 DESC, c2 DESC limit 100;
SELECT c2, c3 FROM table_simple WHERE c2 BETWEEN 100 AND 50000 ORDER BY c2 DESC, c3 DESC limit 50;
...
SELECT c1, c2, c3 FROM table_simple WHERE c1 = 3 ORDER BY c1 DESC, c2 DESC limit 5;
...
SELECT * FROM table_simple WHERE c5 <= 100000 AND (c4 = 4 OR c3 = 4) limit 100;
SELECT * FROM table_simple WHERE c5 <= 100000 AND (c4 <= 10 OR c3 <= 10) limit 100;
...
SELECT c2, c3, row_number() OVER (PARTITION BY c2 ORDER BY c3 NULLS LAST) AS rn, avg(c4) OVER (PARTITION BY c2) AS avg_c4 FROM table_simple WHERE c2 BETWEEN 10 AND 90 AND c3 IS NOT NULL limit 10;
