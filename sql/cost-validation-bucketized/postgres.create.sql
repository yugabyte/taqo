...
create table t100 (c1 int, c2 int not null, c3 int, c4 int, c5 int, c6 int, v char(1024), bucketid int generated always as (mod(abs(c1::bigint + c2::bigint), 3)) stored, primary key (c1));
...
create table t1000 (c1 int, c2 int not null, c3 int, c4 int, c5 int, c6 int, v char(1024), bucketid int generated always as (mod(abs(c1::bigint + c2::bigint), 3)) stored, primary key (c1));
...
create table t10000 (c1 int, c2 int not null, c3 int, c4 int, c5 int, c6 int, v char(1024), bucketid int generated always as (mod(abs(c3::bigint + c5::bigint), 3)) stored, primary key (c1));
...
create table t100000 (c1 int, c2 int not null, c3 int, c4 int, c5 int, c6 int, v char(1024), bucketid int generated always as (mod(abs(c2::bigint + c4::bigint), 3)) stored, primary key (c1));
...
create table t100000w (c1 int, c2 int not null, c3 int, c4 int, c5 int, c6 int, v char(8192), bucketid int generated always as (mod(abs(c1::bigint + c2::bigint), 3)) stored, primary key (c1));
...
create table t1000000m (c0 int, c1 int, c2 int, c3 int, c4 int, c5 int, c6 int, bucketid int generated always as (mod(abs(c0::bigint + c2::bigint), 3)) stored,primary key (c0));
...
create table table_simple (c1 int, c2 int not null, c3 int, c4 int, c5 int, c6 int, v char(1024),bucketid int generated always as (mod(abs(length(v)::bigint + c2::bigint), 3)) stored, primary key (c1));
