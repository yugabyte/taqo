create table t1 (id int, r1 int, primary key (id asc));
create index i_t1_r1 on t1 (r1 asc);

create table t2 (id int, r1 int, r2 int not null, primary key (id asc));
create index i_t2_r2 on t2 (r2 asc);
create unique index u_t2_r1_r2 on t2 (r1 asc, r2 asc);

create table t3 (id int, parent_id int, v text, primary key (id asc));
