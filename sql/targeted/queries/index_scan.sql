...
-- 3.4. Same as above but seek for each matching value of id_asc_2 and id_asc_.
SELECT * FROM t_composite_pk_10k WHERE
    id_hash_1 = 5 and
    id_asc_1 = 50 and
    id_asc_2 > 500 and
...
-- num_seeks = 1, num_nexts higher than previous query.
SELECT * FROM t_composite_pk_10k WHERE
    id_hash_1 = 5 and
    id_asc_1 > 50;
...
-- num_seeks = 1 but fewer num_nexts as the 3 previous queries
SELECT * FROM t_composite_pk_10k WHERE
    id_hash_1 = 5 and
    id_asc_1 = 50 and
    id_asc_2 = 500 and
...
-- Skip scan filters
-- num_seeks ~ 20% of estimated result rows
SELECT * FROM t_composite_pk_10k WHERE
    id_hash_1 = 5 and
    id_asc_1 > 50 and
    id_asc_4 > 2000;

-- num_seeks ~ 50% of estimated result rows
SELECT * FROM t_composite_pk_10k WHERE
    id_hash_1 = 5 and
    id_asc_1 > 50 and
    id_asc_4 > 5000;

-- num_seeks ~ 80% of estimated result rows
SELECT * FROM t_composite_pk_10k WHERE
    id_hash_1 = 5 and
    id_asc_1 > 50 and
    id_asc_4 > 8000;
